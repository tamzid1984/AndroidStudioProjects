    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bitmap licon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_notification);
                //Assign BigText style notification
                NotificationCompat.BigTextStyle bigText = new NotificationCompat.BigTextStyle();
                bigText.bigText("Welcome to sarker, it provides a tutorials related to all technologies in software industry. Here we covered complete tutorials from basic to adavanced topics from all technologies");
                bigText.setSummaryText("By: Sarker");
